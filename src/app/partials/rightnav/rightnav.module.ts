...
export class RightnavModule {
    ...
    constructor(componentFactoryResolver: ComponentFactoryResolver) {
        const cf = componentFactoryResolver.resolveComponentFactory(RightnavComponent);
        ComponentRefProviderService.registerComponentRef('rightnav', ComponentType.PARTIAL, RightnavComponent, cf);
    }
}
